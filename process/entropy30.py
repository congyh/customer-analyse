...
customerId, r, m, f = np.loadtxt('../data/rfm_normalize30.csv',
                                 delimiter=',',
...
# 持久化entropy_matrix
np.savetxt('../data/entropy_matrix30.csv', entropy_matrix, delimiter=',')
...
np.savetxt('../data/similarity_matrix30.csv', similarity_matrix, delimiter=',')
...
with open('../data/entropy30.csv', 'wt') as wf:
...
with open('../data/cluster_center30.csv', 'wt') as wf:
    wf_csv = csv.writer(wf)
